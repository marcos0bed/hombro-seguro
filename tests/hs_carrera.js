...
ok("y el porcentaje suave en el centro",/text-anchor="middle"[^>]*font-weight="700"[^>]*>\d+%<\/text>/.test(i2),"");
ok("que se encoge si son tres cifras",(function(){var m=/font-size="([\d.]+)"[^>]*font-weight="700"/.exec(i2);return m&&+m[1]<=23})(),"");
